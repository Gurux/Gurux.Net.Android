        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    description.set("gurux.net.android package implements TCP/IP or UDP communicatio for Android OS. Purpose of Gurux Device Framework is help you to read your devices, meters and sensors easier")
                    ...
                    scm {
                        connection.set("scm:git:https://github.com/gurux/gurux.net.android.git")
                        developerConnection.set("scm:git:https://github.com/gurux/gurux.net.android.git")
                        url.set("https://github.com/gurux/gurux.net.android")
                    }
                }
                signing {
                    useGpgCmd()
